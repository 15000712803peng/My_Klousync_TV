...
import static com.kloudsync.techexcel2.R.id.pull_to_refresh_image;
 ...
 */
public class CommonMeetingActivity extends BaseActivity implements View.OnClickListener, AGEventHandler, VideoGestureRelativeLayout.VideoGestureListener, AddFileFromFavoriteDialog.OnFavoriteDocSelectedListener, AddFileFromDocumentDialog.OnDocSelectedListener {
...
//                new CenterToast.Builder(WatchCourseActivity2.this).setSuccess(true).setMessage("operate success").create().show();
    ...
    private void fetchCurrentFile(final FileData fileData){
        if(fileData == null || TextUtils.isEmpty(fileData.getFileId())){
            Log.e("CommonMeetingActivity","file data is null");
            return;
        }

        if (lessonId.equals("-1")) {
            Log.e("CommonMeetingActivity","lessonId is null");
            return;
        }
        ...
        MeetingServiceTools.getInstance().getPdfList(url, MeetingServiceTools.GETPDFLIST, new ServiceInterfaceListener() {
            ...
            public void getServiceReturnData(Object object) {
                ...
                lineItem = null;
                if (fileData.getFileId().equals("0")) {
                    lineItem = documentList.get(0);
                } else {
                    LineItem file = new LineItem();
                    file.setItemId(fileData.getFileId());
                ...
                setFileList();
                Log.e("fetchCurrentFile","start load index");
...
//                        notifySwitchDocumentSocket(currentShowPdf, "1");
    ...
    private void loadCurrentFile(LineItem currentFile){

    }

    private class MyHandler extends Handler {

        private WeakReference<CommonMeetingActivity> watchCourseActivity3WeakReference;

        public MyHandler(CommonMeetingActivity watchCourseActivity3) {
            watchCourseActivity3WeakReference = new WeakReference<>(watchCourseActivity3);
        }

        @Override
        public void handleMessage(Message msg) {
            final CommonMeetingActivity activity3 = watchCourseActivity3WeakReference.get();
            if (activity3 != null) {
                switch (msg.what) {
                    case 0x1109:
...
//                        activity3.getServiceDetail();
                        fetchCurrentFile(currentFileData);
...
//        initdefault();
    ...
    private void doJOIN_MEETING(String msg) {
        try {
            ...
            Log.e("doJOIN_MEETING", "isMeetingStarted:" + isMeetingStarted);
            if (isMeetingStarted) {
                isopenvideo(msg);
            }
            ...
            currentFileData.setFileId(page[0]);
            currentFileData.setCurrentPageIndex(Integer.parseInt(page[1]));
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.e("on receive", "message:" + message);
            ...
            if (msg_action.equals("CALL_ME")) {
                if (getRetCodeByReturnData2("retCode", msg).equals("-2403")) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(CommonMeetingActivity.this, "user exist in conference", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }
...
//                currentAttachmentId=getRetCodeByReturnData2("documentId", msg);
            ...
            if (msg_action.equals("END_MEETING")) {
                Log.e("Test_EndMeeting", "end meeting");
                if (getRetCodeByReturnData2("retCode", msg).equals("1")) {
                    if (isHavePresenter()) {
                        Log.e("Test_EndMeeting", "isHavePresenter:true");
                        finish();
                    } else {
                        Log.e("Test_EndMeeting", "finish");
                        finish();
                    }
                }
            }
    ...
    private void initView() {
        ...
        puo2 = new Popupdate2();
        puo2.getPopwindow(CommonMeetingActivity.this);
        ...
        wv_show.addJavascriptInterface(CommonMeetingActivity.this, "AnalyticsWebInterface");
...
//        getLineAction(currentAttachmentPage, true);
    ...
    private void downloadPdf(final String pdfurl, final int page) {
        ...
        FileUtils fileUtils = new FileUtils(CommonMeetingActivity.this);
        ...
        if (fileUtils.isFileExists(fileLocalUrl2)) {
            Log.e("webview-downloadPdf", " 本地文件存在  show pdf 地址  " + showpdfurl + "  " + page + "  " + currentBlankPageNumber + "--Thread:" + Thread.currentThread());
            ...
            DownloadUtil.get().download(downloadurl, fileLocalUrl, new DownloadUtil.OnDownloadListener() {
                ...
                public void onDownloadFailed() {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            filedownprogress.setVisibility(View.GONE);
                            Toast.makeText(CommonMeetingActivity.this, " download failed", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            });
    ...
    private void downEveryOnePdf(final String url, final int currentpageNum) {
        ...
        if (currentpageNum <= pageCount && currentpageNum >= 0) {
            ...
            final FileUtils fileUtils = new FileUtils(CommonMeetingActivity.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (code == 1) {
                        Toast.makeText(CommonMeetingActivity.this, "Not Current Page", Toast.LENGTH_LONG).show();
                    } else if (code == 2) {
                        Toast.makeText(CommonMeetingActivity.this, "Not Support", Toast.LENGTH_LONG).show();
                    } else if (code == 3) {
                        Toast.makeText(CommonMeetingActivity.this, "Not Current Document ", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//        }
    ...
    private void initDocumentListAudienceList() {
        ...
        take_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Environment.MEDIA_MOUNTED.equals(Environment
                    ...
                    Toast.makeText(CommonMeetingActivity.this, "请插入SD卡", Toast.LENGTH_SHORT).show();
                    return;
                }
                closeAlbum();
        ...
        save_file.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                upload_linearlayout.setVisibility(View.GONE);
                addFileFromFavoriteDialog = new AddFileFromFavoriteDialog(CommonMeetingActivity.this);
                addFileFromFavoriteDialog.setOnFavoriteDocSelectedListener(CommonMeetingActivity.this);
    ...
    private void moreActionPopupWindow() {
        ...
        moreactionPopup.getPopwindow(CommonMeetingActivity.this);
...
//        Toast.makeText(WatchCourseActivity3.this, mGroupId, Toast.LENGTH_LONG).show();
        ...
        chatAdapter = new ChatAdapter(CommonMeetingActivity.this, chatMessages);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(context)) {
                    ...
                    Tools.sendMessage(CommonMeetingActivity.this, myTextMessage, mGroupId, AppConfig.UserID);
                    editText.setText("");
                }
            }
        });
        ...
        icon_socket_chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Tools.openGroup(CommonMeetingActivity.this, mGroupId);
    ...
    private void openSaveVideoPopup() {
        ...
        favoritePopup.getPopwindow(CommonMeetingActivity.this);
        ...
        switch (id) {
            case R.id.addauditorimageview: //添加旁听者
                if (identity == 1 || identity == 2) {
                    Intent startAuditor = new Intent(CommonMeetingActivity.this, AddAuditorActivity.class);
                ...
                newPath, new ServiceInterfaceListener() {
                    ...
                    public void getServiceReturnData(Object object) {
                        ...
                        if (2 == xx) {
                            ...
                            Toast.makeText(CommonMeetingActivity.this, "Not find the file.", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
                    ...
                    public void getServiceReturnData(Object object) {
                        ...
                        if (soundtrackBean.getNewAudioAttachmentID() != 0) {
                            if (uploadao.getServiceProviderId() == 0) {
                                ...
                                lg.GetprepareUploading(CommonMeetingActivity.this);
                            } else {
    ...
    private void callMeOrLater(final int identity, String phoneNumber) {
        ...
        startLessonPopup.getPopwindow(CommonMeetingActivity.this, identity, phoneNumber);
    ...
    private void detectPopwindow(int countDown) {
        ...
        detchedPopup.getPopwindow(CommonMeetingActivity.this, (RelativeLayout) findViewById(R.id.layout), countDown);
    ...
    private void endDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CommonMeetingActivity.this);
        builder.setTitle("")
    ...
    private void initVideoPopup() {
        ...
        videoPopuP.getPopwindow(CommonMeetingActivity.this, screenWidth, (RelativeLayout) findViewById(R.id.bottomrl));
        // 两种情况
    ...
    private void openMySavePopup(final List<Favorite> favoriteList, final int type) {
        ...
        favoritePopup.getPopwindow(CommonMeetingActivity.this, favoriteList, type);
    ...
    private void playVideo(final String path, final float time) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                videoView.seekTo((int) time * 1000);
                if (isHavePresenter()) {
                    MediaController mc = new MediaController(CommonMeetingActivity.this);
...
//        }
        ...
        Log.e("SyncRoomActivity", "currentShowPdf:" + lineItem.toString());
...
//            Toast.makeText(WatchCourseActivity3.this,"按下了返回键",Toast.LENGTH_LONG).show();
    ...
    public void uploadFile2(final LineItem attachmentBean) {
        ...
        lg.setprepareUploadingGetListener(new LoginGet.prepareUploadingGetListener() {
            ...
            public void getUD(Uploadao ud) {
                ...
                if (myRecyclerAdapter2 == null) {
                    myRecyclerAdapter2 = new MyRecyclerAdapter2(CommonMeetingActivity.this, documentList);
                    documentrecycleview.setAdapter(myRecyclerAdapter2);
                } else {
                    myRecyclerAdapter2.notifyDataSetChanged();
                }
            ...
            ServiceInterfaceTools.getinstance().uploadNewFile(AppConfig.URL_PUBLIC + "EventAttachment/UploadNewFile", ServiceInterfaceTools.UPLOADNEWFILE,
                    fileName, uploadao, lessonId, MD5Hash, convertingResult, isAddToFavorite, field, new ServiceInterfaceListener() {
                        ...
                        public void getServiceReturnData(Object object) {
                            ...
                            getServiceDetail();
                            Toast.makeText(CommonMeetingActivity.this, "upload success", Toast.LENGTH_LONG).show();
                        }
                    }
            );
    ...
    protected void initUIandEvent() {
        ...
        mSmallLeftAgoraAdapter = new RightAgoraAdapter(CommonMeetingActivity.this);
        ...
        mLeftAgoraAdapter = new DefaultAgoraAdapter(CommonMeetingActivity.this);
        ...
        mRightAgoraAdapter = new RightAgoraAdapter(CommonMeetingActivity.this);
        ...
        mBigAgoraAdapter = new BigAgoraAdapter(CommonMeetingActivity.this);
...
//                Log.e("logout_respose", responsedata.toString() + "");
                getSharedPreferences(AppConfig.LOGININFO,
                        MODE_PRIVATE).edit().putString("tv_bind_user", "");
                AppConfig.BINDUSERID = "";
                Intent qrcodeIntent = new Intent(CommonMeetingActivity.this, QrCodeActivity.class);
