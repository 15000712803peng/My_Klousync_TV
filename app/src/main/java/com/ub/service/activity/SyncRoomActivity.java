...
public class SyncRoomActivity extends BaseActivity implements View.OnClickListener, AGEventHandler, VideoGestureRelativeLayout.VideoGestureListener, AddFileFromFavoriteDialog.OnFavoriteDocSelectedListener, AddFileFromDocumentDialog.OnDocSelectedListener {
    ...
    public static SyncRoomActivity instance = null;
...
//        }
        ...
        take_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Environment.MEDIA_MOUNTED.equals(Environment
                    ...
                    Toast.makeText(SyncRoomActivity.this, "请插入SD卡", Toast.LENGTH_SHORT).show();
                    return;
                }
                closeAlbum();
    ...
    private void moreActionPopupWindow() {
        ...
        moreactionPopup.getPopwindow(SyncRoomActivity.this);
...
//        Toast.makeText(WatchCourseActivity3.this, mGroupId, Toast.LENGTH_LONG).show();
    ...
    private void openSaveVideoPopup() {
        ...
        favoritePopup.getPopwindow(SyncRoomActivity.this);
...
//                getWindow().getDecorView().setAlpha(0.5f);
    ...
    private void callMeOrLater(final int identity, String phoneNumber) {
        ...
        startLessonPopup.getPopwindow(SyncRoomActivity.this, identity, phoneNumber);
    ...
    private void endDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SyncRoomActivity.this);
        builder.setTitle("")
    ...
    private void openMySavePopup(final List<Favorite> favoriteList, final int type) {
        ...
        favoritePopup.getPopwindow(SyncRoomActivity.this, favoriteList, type);
...
//        }
    ...
    public void uploadFile2(final LineItem attachmentBean) {
        ...
        lg.setprepareUploadingGetListener(new LoginGet.prepareUploadingGetListener() {
            ...
            public void getUD(Uploadao ud) {
                ...
                if (myRecyclerAdapter2 == null) {
                    myRecyclerAdapter2 = new MyRecyclerAdapter2(SyncRoomActivity.this, documentList);
                    documentrecycleview.setAdapter(myRecyclerAdapter2);
                } else {
                    myRecyclerAdapter2.notifyDataSetChanged();
                }
    ...
    protected void initUIandEvent() {
        ...
        mSmallLeftAgoraAdapter = new RightAgoraAdapter(SyncRoomActivity.this);
        ...
        mLeftAgoraAdapter = new DefaultAgoraAdapter(SyncRoomActivity.this);
        ...
        mRightAgoraAdapter = new RightAgoraAdapter(SyncRoomActivity.this);
        ...
        mBigAgoraAdapter = new BigAgoraAdapter(SyncRoomActivity.this);
