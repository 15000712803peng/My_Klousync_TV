...
public class RightAgoraAdapter extends RecyclerView.Adapter<RightAgoraAdapter.ViewHolder> {
    ...
    public RightAgoraAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (holderView.getChildCount() == 0) {
            ...
            if (agoraBean.isMuteVideo() == false) {
                ...
                holderView.addView(target, 0, new FrameLayout.LayoutParams(DensityUtil.dp2px(mContext, 60), DensityUtil.dp2px(mContext, 60)));
            }
//            holderView.setLayoutParams(new FrameLayout.LayoutParams(DensityUtil.dp2px(mContext, 60), framelayoutHeight / flag));
            holderView.setLayoutParams(new FrameLayout.LayoutParams(DensityUtil.dp2px(mContext, 60), DensityUtil.dp2px(mContext, 60)));
        }
