...
public class ServiceAdapter2 extends BaseAdapter {
    ...
    public ServiceAdapter2(Context context, List<ServiceBean> serviceList, boolean isPublic,boolean isShow) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.studentname.setText(bean.getCustomer().getName());
