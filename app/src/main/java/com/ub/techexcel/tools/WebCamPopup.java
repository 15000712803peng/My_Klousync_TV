...
import com.ub.techexcel.adapter.OptionsAdapter;
...
//                ll.setVisibility(View.GONE);
    ...
    public void initPopuptWindow() {
        ...
        view = (ViewGroup) layoutInflater.inflate(R.layout.webcam_popup, null);

        tv1 = (ImageView) view.findViewById(R.id.tv1);
        tv2 = (ImageView) view.findViewById(R.id.tv2);
        closeText = (TextView) view.findViewById(R.id.txt_closed);
