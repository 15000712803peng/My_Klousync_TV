package com.kloudsync.techexcel2.pc.adapter;
...
public class AllListFilterAdapter extends CommonAdapterW<ConditionBean> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final com.kloudsync.techexcel2.adapter.ViewHolder viewHolder = com.kloudsync.techexcel2.adapter.ViewHolder.get(context, convertView,
