...
import com.kloudsync.techexcel2.adapter.HeaderRecyclerAdapter;

import com.kloudsync.techexcel2.config.AppConfig;
import com.kloudsync.techexcel2.pc.bean.Team;
...
public class AddFileFromDocumentDialog implements View.OnClickListener, HeaderRecyclerAdapter.OnItemClickListener {
    ...
    public void initDialog() {
        ...
        teamList = (RecyclerView) selectTeamView.findViewById(R.id.list_team);
        teamList.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false));
        spaceList = (RecyclerView) selectSpaceView.findViewById(R.id.list_space);
        ...
        docTeamName = (TextView) selectDocumentView.findViewById(R.id.txt_doc_team_name);
        docSpaceName = (TextView) selectDocumentView.findViewById(R.id.txt_doc_space_name);
        spaceCloseImage = (ImageView) selectSpaceView.findViewById(R.id.img_close);
        spaceCloseImage = (ImageView) selectSpaceView.findViewById(R.id.img_close);
        docCloseImage = (ImageView) selectDocumentView.findViewById(R.id.doc_img_close);
        docCloseImage.setOnClickListener(this);
        spaceCloseImage.setOnClickListener(this);
        teamNameText = (TextView) selectSpaceView.findViewById(R.id.txt_team_name);
        closeImage = (ImageView) selectTeamView.findViewById(R.id.img_close);
        selectTeamLayout = (LinearLayout) selectSpaceView.findViewById(R.id.layout_select_team);
        selectSpaceLayout = (LinearLayout) selectSpaceView.findViewById(R.id.layout_select_team);
        docSelectSpaceLayout = (LinearLayout) selectDocumentView.findViewById(R.id.layout_doc_select_space);
        docSelectTeamLayout = (LinearLayout) selectDocumentView.findViewById(R.id.layout_doc_select_team);
        docSelectSpaceLayout.setOnClickListener(this);
        docSelectTeamLayout.setOnClickListener(this);
        documentList = (RecyclerView) selectDocumentView.findViewById(R.id.list_document);
        docSaveText = (TextView) selectDocumentView.findViewById(R.id.save);
        docSaveText.setOnClickListener(this);
        docCancelText = (TextView) selectDocumentView.findViewById(R.id.cancel);
...
//            }
    ...
    public class SingleTeamAdapter extends HeaderRecyclerAdapter<Team> {
        ...
        class ItemHolder extends RecyclerView.ViewHolder {
            ...
            public ItemHolder(View itemView) {
                super(itemView);
                teamNameText = (TextView) itemView.findViewById(R.id.txt_team_name);
                itemLayout = (LinearLayout) itemView.findViewById(R.id.lin_favour);
    ...
    public class SpaceAdapter extends HeaderRecyclerAdapter<TeamSpaceBean> {
        ...
        class ItemHolder extends RecyclerView.ViewHolder {
            ...
            public ItemHolder(View itemView) {
                super(itemView);
                spaceNameText = (TextView) itemView.findViewById(R.id.txt_space_name);
