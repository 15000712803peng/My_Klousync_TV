...
import com.kloudsync.techexcel2.adapter.CommonUsedAdapter;
import com.kloudsync.techexcel2.adapter.KnowledgeAdapter;
...
public class SendKnowledge extends Activity {
	...
	private void GetConcernHierarchy() {
		...
		loginget.setDialogGetListener(new LoginGet.DialogGetListener() {
