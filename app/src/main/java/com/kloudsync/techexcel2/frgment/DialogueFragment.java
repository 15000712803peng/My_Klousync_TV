...
import com.kloudsync.techexcel2.dialog.AddGroupActivity;
...
import com.kloudsync.techexcel2.info.AddFriend;
import com.kloudsync.techexcel2.info.Customer;
import com.kloudsync.techexcel2.info.Friend;
...
//				loginget.MemberRequest(getActivity(), 0);
        ...
        loginget.setDetailGetListener(new LoginGet.DetailGetListener() {
            ...
            public void getUser(Customer user) {
                AppConfig.MYAVATARURL = user.getUrl() + "";
                customer = user;
        ...
        loginget.setGroupsGetListener(new LoginGet.GroupChatsGetListener() {
    ...
    private void SetUserProvider() {
        RongIM.setUserInfoProvider(new RongIM.UserInfoProvider() {
            ...
            public UserInfo getUserInfo(String userId) {
                ...
                if (userId.equals(customer.getUBAOUserID())) {
                    Uri uri = null;
...
//                    DeleteMessage(msg);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            //解决验证切换语言时列表没刷新
            if (tv_cancel != null && null == customer) {
                initView();
            }
        }
        RefreshInfo();
